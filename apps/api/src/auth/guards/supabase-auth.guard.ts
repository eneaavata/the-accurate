import { CanActivate, ExecutionContext, Injectable, UnauthorizedException, Inject, Scope } from "@nestjs/common";
...
export class SupabaseAuthGuard implements CanActivate {
    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        const strict = this.reflector.getAllAndOverride<boolean>(STRICT_SESSION_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
